(function () {
	...
	var I$1 = Array.isArray, J = Object.prototype.hasOwnProperty, K$1 = { current: null }, L$1 = {
	    key: !0,
	    ref: !0,
	    __self: !0,
	    __source: !0
	...
	function R$1(a, b, e, d, c) {
	  ...
	  if (h)
	    return h = a, c = c(h), a = '' === d ? '.' + Q$1(h, 0) : d, I$1(c) ? (e = '', null != a && (e = a.replace(P$1, '$&/') + '/'), R$1(c, b, e, '', function (a) {
	      return a;
	...
	var U$1 = { current: null }, V$1 = { transition: null }, W$1 = {
	...
	var rd = {
	  ...
	  }), Ad = qd(zd), Bd = A({}, zd, { dataTransfer: 0 }), Cd = qd(Bd), Dd = A({}, td, { relatedTarget: 0 }), Ed = qd(Dd), Fd = A({}, rd, {
	    animationName: 0,
	    elapsedTime: 0,
	    pseudoElement: 0
	  }), Gd = qd(Fd), Hd = A({}, rd, {
	...
	var be = ia && 'TextEvent' in window && !ae, ce = ia && (!$d || ae && 8 < ae && 11 >= ae), de = String.fromCharCode(32), ee = !1;
	function fe(a, b) {
	  switch (a) {
	  case 'keyup':
	...
	function je(a, b) {
	  if (he)
	    return 'compositionend' === a || !$d && fe(a, b) ? (a = md(), ld = kd = jd = null, he = !1, a) : null;
	  switch (a) {
	  case 'paste':
	    return null;
	  case 'keypress':
	    ...
	    if (0 === (b & 7)) {
	      ...
	      a: {
	        ...
	        if ('select' === k || 'input' === k && 'file' === h.type)
	          ...
	          (k = h.nodeName) && 'input' === k.toLowerCase() && ('checkbox' === h.type || 'radio' === h.type) && (Z = De);
	        if (Z && (Z = Z(a, d))) {
	          me(g, Z, c, e);
	          break a;
	        }
	      ...
	      if (ab = be ? ie(a, c) : je(a, c))
	        d = ne(d, 'onBeforeInput'), 0 < d.length && (e = new Kd('onBeforeInput', 'beforeinput', null, c, e), g.push({
	          event: e,
	          listeners: d
	        }), e.data = ab);
	    }
	...
	function Yi(a, b, c) {
	  ...
	  case 19:
	    ...
	    if (null === g)
	      ...
	      if (!d)
	        if (a = Jh(g), null !== a) {
	          if (b.flags |= 128, d = !0, c = a.updateQueue, null !== c && (b.updateQueue = c, b.flags |= 4), Xi(f, !0), null === f.tail && 'hidden' === f.tailMode && !g.alternate && !I)
	            return Q(b), null;
	        } else
	          2 * B() - f.renderingStartTime > aj && 1073741824 !== c && (b.flags |= 128, d = !0, Xi(f, !1), b.lanes = 4194304);
	...
	function vj(a, b, c) {
	  var d = b.pendingProps, e = K.current, f = !1, g = 0 !== (b.flags & 128), h;
	  ...
	  if (null !== e) {
	    ...
	    if (null !== h) {
	      ...
	      if (0 === (b.mode & 1))
	        ...
	        '$?' === h.data ? (b.flags |= 128, b.child = a.child, b = zj.bind(null, a), h._reactRetry = b, b = null) : (c = e.treeContext, eh = Kf(h.nextSibling), dh = b, I = !0, fh = null, null !== c && (Vg[Wg++] = Yg, Vg[Wg++] = Zg, Vg[Wg++] = Xg, Yg = c.id, Zg = c.overflow, Xg = b), b = xj(b, b.pendingProps.children), b.flags |= 4096);
	      return b;
	    }
	    if (f)
	...
	var jk = Math.ceil, kk = ta.ReactCurrentDispatcher, lk = ta.ReactCurrentOwner, mk = ta.ReactCurrentBatchConfig, W = 0, P = null, X = null, Y = 0, cj = 0, mj = Tf(0), R = 0, nk = null, Fg = 0, ok = 0, pk = 0, qk = null, rk = null, dk = 0, aj = Infinity, sk = null, Li = !1, Mi = null, Oi = null, tk = !1, uk = null, vk = 0, wk = 0, xk = null, yk = -1, zk = 0;
	function Jg() {
	...
	Uk = function (a, b, c) {
	  if (null !== a)
	    ...
	    tg = !1, I && 0 !== (b.flags & 1048576) && ah(b, Ug, b.index);
	  b.lanes = 0;
	  switch (b.tag) {
	  case 2:
	    var d = b.type;
	    ...
	    a: {
	      ...
	      if (f.isDehydrated)
	        if (f = {
	          ...
	          for (eh = Kf(b.stateNode.containerInfo.firstChild), dh = b, I = !0, fh = null, c = zh(b, null, d, c), b.child = c; c;)
	...
	function UI(_a) {
	  ...
	  var _b = react.exports.useState(0), number = _b[0], setNumber = _b[1];
	  return React.createElement(React.Fragment, null, React.createElement('h1', null, 'Number: ', number), React.createElement('button', {
	    onClick: function () {
	      return setNumber(function (number) {
	        return number + 1;
	      });
	    }
	  }, 'Click'), React.createElement('button', {
	    onClick: function () {
	      return resolve('woah: ' + number);
	    }
	  }, 'Finish it'));
	}

	var root = undefined;
	function setupReactApp(resolveFunction) {
	  root = createRoot(document.getElementById('root'));
	  root.render(React.createElement(React.StrictMode, null, React.createElement(UI, { resolve: resolveFunction })));
	}
