...
export default function AnnotateType() {
    ...
    return (React.createElement("div", { ref: parent },
        React.createElement(SelectionContainer, null,
            React.createElement(Select, { classNamePrefix: "select", name: "itemtype", onChange: function (selection) { return setSelection(selection); }, value: selection, options: SchemaTypes })),
        selection && (React.createElement(React.Fragment, null,
            React.createElement(SmallText, null, "Type description:"),
