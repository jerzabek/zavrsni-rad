...
module.exports = (grunt) => {
  ...
  grunt.initConfig({
    ...
    concat: {
      license: {
        ...
        files: {
          'dist/tinymce-bsc-thesis-tinymce-example/plugin.js': [
            'src/text/license-header.js',
            scratchPluginMinPath
          ],
          'dist/tinymce-bsc-thesis-tinymce-example/plugin.min.js': [
            'src/text/license-header.js',
            scratchPluginMinPath
          ]
        }
    ...
    copy: {
      css: {
        files: [
          { src: [ 'CHANGELOG.txt', 'LICENSE.txt' ], dest: 'dist/tinymce-bsc-thesis-tinymce-example', expand: true }
        ]
      }
    },
  ...
  grunt.registerTask('version', 'Creates a version file', () => {
    grunt.file.write('dist/tinymce-bsc-thesis-tinymce-example/version.txt', BUILD_VERSION);
  });
