@jerzabek/ckeditor5-bsc-thesis-ckeditor-example
===============================================
...
The `@jerzabek/ckeditor5-bsc-thesis-ckeditor-example` package is available under [MIT license](https://opensource.org/licenses/MIT).
